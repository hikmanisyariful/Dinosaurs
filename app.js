...
Dino.prototype.compareDiet = function() {
  if (humanObj.diet.toLowerCase() === this.diet) {
    return `${this.species} is a ${this.diet}, that is just like you.`;
  } else {
    return `${this.species} is a ${this.diet}, that is unlike you.`;
  }
};
